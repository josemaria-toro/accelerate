...
public abstract class BaseEntityFrameworkRepository<TEntity, TOptions> : IRepository<TEntity> where TEntity : class, IEntity, new()
                                                                                              where TOptions : BaseEntityFrameworkRepositoryOptions
{
    private Boolean _disposed;
    private EntityFrameworkContext<TEntity, TOptions> _context;
    ...
    protected EntityFrameworkContext<TEntity, TOptions> Context { get => _context; }
