...
/// <summary>
/// Represents an implementation for a custom PostgreSQL-based repository for events.
/// </summary>
internal sealed class EventsRepository : PostgreSqlRepository<EventEntity, PostgreSqlRepositoryOptions>
{
    /// <summary>
    ...
    /// </param>
    public EventsRepository(IOptions<PostgreSqlRepositoryOptions> options) : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<EventEntity>()
                    .ToTable("tg_events", Options.Schema)
                    .HasKey(x => x.Id);
