...
{
    /// <summary>
    /// Represent an error that occur when an Object already exists and the operation don't allow duplicated values.
    /// </summary>
    public class ConflictException : AccelerateException
    {
        /// <summary>
