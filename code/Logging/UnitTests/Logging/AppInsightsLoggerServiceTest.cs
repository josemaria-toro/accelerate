...
/// <summary>
/// Class to perform unit tests of AppInsightsLoggerService class.
/// </summary>
[ExcludeFromCodeCoverage]
public class AppInsightsLoggerServiceTest : xUnitTest<AppInsightsLoggerTestContext>
{
    /// <summary>
    ...
    /// </param>
    public AppInsightsLoggerServiceTest(AppInsightsLoggerTestContext context) : base(context)
    {
    }
    ...
    public void BeginScope_Success()
    {
        ...
        var loggerService = new AppInsightsLoggerService(options);
    ...
    public void Ctor_Throwing_Exception()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            var loggerService = new AppInsightsLoggerService(null);
        });
    }
    /// <summary>
    /// Method to perform unit test of constructor.
    ...
    {
        var options = Options.Create(Context.LoggerServiceOptions);
        var loggerService = new AppInsightsLoggerService(options, "Default");
    ...
    public void Ctor_With_Category_Throwing_Exception_By_Category()
    {
        ...
        {
            var options = Options.Create(Context.LoggerServiceOptions);
            var loggerService = new AppInsightsLoggerService(options, null);
        });
    }
    /// <summary>
    /// Method to perform unit test of constructor raising an exception of type ArgumentException.
    ...
    public void Ctor_With_Category_Throwing_Exception_By_Options()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            var loggerService = new AppInsightsLoggerService(null, "Default");
        });
    }
    /// <summary>
    ...
    public void Dispose_Success()
    {
        ...
        using var loggerService = new AppInsightsLoggerService(options);
