...
/// <summary>
/// Class to perform unit tests of DatabaseLoggerService class.
/// </summary>
[ExcludeFromCodeCoverage]
public class DatabaseLoggerServiceTest : xUnitTest<DatabaseLoggerTestContext>
{
    /// <summary>
    ...
    /// </param>
    public DatabaseLoggerServiceTest(DatabaseLoggerTestContext context) : base(context)
    {
    }
    ...
    public void BeginScope_Success()
    {
        ...
        var loggerService = new DatabaseLoggerService(options, Context.Connection);
    ...
    public void Ctor_Throwing_Exception()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            var loggerService = new DatabaseLoggerService(null, Context.Connection);
        });
    }
    /// <summary>
    /// Method to perform unit test of constructor.
    ...
    {
        var options = Options.Create(Context.LoggerServiceOptions);
        var loggerService = new DatabaseLoggerService(options, Context.Connection, "Default");
    ...
    public void Ctor_With_Category_Throwing_Exception_By_Category()
    {
        ...
        {
            var options = Options.Create(Context.LoggerServiceOptions);
            var loggerService = new DatabaseLoggerService(options, Context.Connection, null);
        });
    }
    /// <summary>
    /// Method to perform unit test of constructor raising an exception of type ArgumentException.
    /// </summary>
    [Fact]
    public void Ctor_With_Category_Throwing_Exception_By_Connection()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            var options = Options.Create(Context.LoggerServiceOptions);
            var loggerService = new DatabaseLoggerService(options, null, "Default");
        });
    }
    /// <summary>
    /// Method to perform unit test of constructor raising an exception of type ArgumentException.
    ...
    public void Ctor_With_Category_Throwing_Exception_By_Options()
    {
        Assert.Throws<ArgumentException>(() =>
        {
            var loggerService = new DatabaseLoggerService(null, Context.Connection, "Default");
        });
    }
    /// <summary>
    ...
    public void Dispose_Success()
    {
        ...
        using var loggerService = new DatabaseLoggerService(options, Context.Connection);
